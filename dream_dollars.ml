...
(*
   Given an amount n, find the shortest list of bills such that their sum equals n
*)
...
(*
   Given an amount n, for each bill, let s_b donate the recursively computed shortest list 
   to change n-bill. Take the shortest s_b and add its corresponding bill b to it to change the ampunt n.
*)
